...
@interface HTViewController () <HTCopyableLabelDelegate>
...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(hidene) name:UIMenuControllerWillHideMenuNotification object:nil];
}
...
//     [UIMenuController sharedMenuController].menuVisible = NO;
     self.labelContainer1.backgroundColor = [UIColor clearColor];
}
...
- (CGRect)copyMenuTargetRectInCopyableLabelCoordinates:(HTCopyableLabel *)copyableLabel
{
        ...
        || copyableLabel == self.label4)
    {
        ...
        self.labelContainer1.backgroundColor = [UIColor redColor];
    }
    else if (copyableLabel == self.label5)
    {
